...
lightSources[0].setPosition( -0.5, 0.3, 1.0, 1.0 );

lightSources[0].setIntensity( 1.0, 1.0, 1.0 );

lightSources[0].setAmbIntensity( 0.1, 0.1, 0.1 );

lightSources.push( new LightSource() );

lightSources[1].setPosition( 0.0, 1.0, 1.0, 0.0 );

lightSources[1].setIntensity( 1.0, 0.5, 0.1 );

lightSources[1].setAmbIntensity( 0.1, 0.1, 0.1 );
